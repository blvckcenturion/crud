...
import {
  fetchActivePurchasesWithItems,
  fetchActivePurchasesWithNoCosts,
} from "@/lib/services/supabase/purchase";
...
export function ImportCostsForm({
  ...
  // Queries
  const { data: purchases, isLoading: isLoadingProducts } = useQuery(
    "purchases",
    fetchActivePurchasesWithNoCosts
  );
  ...
  async function onSubmit(data: ImportCostsFormSchema) {
    try {
      ...
      const selectedPurchase = purchases?.find(
        (purchase) => purchase.id === data.order_id
      );
      ...
      const values: IntermediateImportCostsReturnSchema =
        await calculateImportCostValues(data);
      const mappedData: InsertImportCostsSchema = {
        ...
        net_total_warehouse_cost_calculated:
          values.net_total_warehouse_cost_calculated,
      };
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="form-flex px-2 space-y-8 overflow-y-auto max-h-[80vh]"
      >
        {importCost && (
          <FormField
            name="providerName"
        ...
        <FormField
          control={form.control}
          name="maritime_transportation"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="maritime_transportation">
                Transporte Marítimo
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="land_transportation"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="land_transportation">
        ...
        <FormField
          control={form.control}
          name="foreign_insurance"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="foreign_insurance">
        ...
        <FormField
          control={form.control}
          name="aspb_port_expenses"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="aspb_port_expenses">
                Gastos Portuarios ASPB
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="intermediary_commissions"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="intermediary_commissions">
        ...
        <FormField
          control={form.control}
          name="consolidated_tax_duty"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="consolidated_tax_duty">
                Gravamen Impuesto Consolidado (GAC)
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="specific_consumption_tax_ice"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="specific_consumption_tax_ice">
        ...
        <FormField
          control={form.control}
          name="other_penalties"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_penalties">
                Contravenciones Otros
              </FormLabel>
              <FormControl>
                <Input
                  id="other_penalties"
        ...
        <FormField
          control={form.control}
          name="albo_customs_storage"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="albo_customs_storage">
                Almacenaje Aduana ALBO S.A.
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="albo_customs_logistics"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="albo_customs_logistics">
                Logística Aduana ALBO S.A.
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="chamber_of_commerce">
                Cámara Comercio
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="custom_agent_commissions"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="custom_agent_commissions">
                Comisiones Agente Despachante Aduana
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="financial_commissions"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="financial_commissions">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_commissions">
                Otras Comisiones
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="national_transportation"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="national_transportation">
                Transporte Nacional
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="handling_and_storage">
                Cargos y Manipuleo
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="other_expenses_iii"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_expenses_iii">
                Otros Gastos III
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_1"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_1">
                Gasto opcional 1
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_2"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_2">
                Gasto opcional 2
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_3"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_3">
                Gasto opcional 3
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_4"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_4">
                Gasto opcional 4
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_5"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_5">
                Gasto opcional 5
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="maritime_transportation_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="maritime_transportation_detail">
        ...
        <FormField
          control={form.control}
          name="land_transportation_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="land_transportation_detail">
                Detalle Transporte Terrestre
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="foreign_insurance_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="foreign_insurance_detail">
                Detalle Seguro en el Extranjero
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="aspb_port_expenses_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="aspb_port_expenses_detail">
                Detalle Gastos Portuarios ASPB
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="intermediary_commissions_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="intermediary_commissions_detail">
                Detalle Comisiones Intermediarios
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="other_expenses_i_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_expenses_i_detail">
                Detalle Otros Gastos I
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="consolidated_tax_duty_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="consolidated_tax_duty_detail">
                Detalle Gravamen Impuesto Consolidado (GAC)
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="value_added_tax_iva_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="value_added_tax_iva_detail">
                Detalle Impuesto al Valor Agregado (IVA)
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="specific_consumption_tax_ice_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="specific_consumption_tax_ice_detail">
                Detalle Impuesto al Consumo Especifico (ICE)
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="other_penalties_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_penalties_detail">
                Detalle Contravenciones Otros
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="albo_customs_storage_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="albo_customs_storage_detail">
                Detalle Almacenaje Aduana ALBO S.A.
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="albo_customs_logistics_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="albo_customs_logistics_detail">
                Detalle Logística Aduana ALBO S.A.
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="dui_forms_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="dui_forms_detail">
                Detalle Formularios DUI
              </FormLabel>
              <FormControl>
                <Input
                  id="dui_forms_detail"
        ...
        <FormField
          control={form.control}
          name="djv_forms_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="djv_forms_detail">
                Detalle Formularios DJV
              </FormLabel>
              <FormControl>
                <Input
                  id="djv_forms_detail"
        ...
        <FormField
          control={form.control}
          name="other_expenses_ii_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_expenses_ii_detail">
                Detalle Otros Gastos II
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="chamber_of_commerce_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="chamber_of_commerce_detail">
                Detalle Cámara Comercio
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="custom_agent_commissions_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="custom_agent_commissions_detail">
                Detalle Comisiones Agente Despachante Aduana
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="financial_commissions_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="financial_commissions_detail">
                Detalle Comisiones Financieras
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="other_commissions_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_commissions_detail">
                Detalle Otras Comisiones
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="handling_and_storage_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="handling_and_storage_detail">
                Detalle Cargos y Manipuleo
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="national_transportation_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="national_transportation_detail">
                Detalle Transporte Nacional
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="other_expenses_iii_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_expenses_iii_detail">
                Detalle Otros Gastos III
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_1_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_1_detail">
                Detalle Gasto opcional 1
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_2_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_2_detail">
                Detalle Gasto opcional 2
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_3_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_3_detail">
                Detalle Gasto opcional 3
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_4_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_4_detail">
                Detalle Gasto opcional 4
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_5_detail"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_5_detail">
                Detalle Gasto opcional 5
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="consolidated_tax_duty_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="consolidated_tax_duty_iva">
                IVA | Gravamen Impuesto Consolidado (GAC)
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="value_added_tax_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="value_added_tax_iva">
        ...
        <FormField
          control={form.control}
          name="value_added_tax_iva_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="value_added_tax_iva_iva">
        ...
        <FormField
          control={form.control}
          name="specific_consumption_tax_ice_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="specific_consumption_tax_ice_iva">
                IVA | Impuesto al Consumo Especifico (ICE)
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="other_penalties_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_penalties_iva">
                IVA | Contravenciones Otros
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="albo_customs_storage_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="albo_customs_storage_iva">
                IVA | Almacenaje Aduana ALBO S.A.
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="albo_customs_logistics_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="albo_customs_logistics_iva">
                IVA | Logística Aduana ALBO S.A.
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="dui_forms_iva">
                IVA | Formularios DUI
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="djv_forms_iva">
                IVA | Formularios DJV
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="other_expenses_ii_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_expenses_ii_iva">
                IVA | Otros Gastos II
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="chamber_of_commerce_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="chamber_of_commerce_iva">
                IVA | Cámara Comercio
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="custom_agent_commissions_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="custom_agent_commissions_iva">
                IVA | Comisiones Agente Despachante Aduana
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="financial_commissions_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="financial_commissions_iva">
                IVA | Comisiones Financieras
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="other_commissions_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_commissions_iva">
        ...
        <FormField
          control={form.control}
          name="national_transportation_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="national_transportation_iva">
                IVA Transporte Nacional
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="handling_and_storage_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="handling_and_storage_iva">
                IVA | Cargos y Manipuleo
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="other_expenses_iii_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="other_expenses_iii_iva">
                IVA | Otros Gastos III
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_1_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_1_iva">
                IVA | Gasto opcional 1
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_2_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_2_iva">
                IVA | Gasto opcional 2
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_3_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_3_iva">
                IVA | Gasto opcional 3
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_4_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_4_iva">
                IVA | Gasto opcional 4
              </FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          control={form.control}
          name="optional_expense_5_iva"
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor="optional_expense_5_iva">
                IVA | Gasto opcional 5
              </FormLabel>
              <FormControl>
                <Input
        ...
        {importCost && (
          <FormField
            name="total_warehouse_cost"
            render={({ field }) => (
              <FormItem>
                <FormLabel htmlFor="net_total_warehouse_cost">
                  Costo Total Almacenes
                </FormLabel>
                <FormControl>
                  <Input
        ...
        {importCost && (
          <FormField
            name="net_total_warehouse_cost"
            render={({ field }) => (
              <FormItem>
                <FormLabel htmlFor="net_total_warehouse_cost">
                  Costo Total Neto Almacenes
                </FormLabel>
                <FormControl>
                  <Input
                    id="net_total_warehouse_cost"
        ...
        {importCost && (
          <FormField
            name="net_total_warehouse_cost_calculated"
            render={({ field }) => (
              <FormItem>
                <FormLabel htmlFor="net_total_warehouse_cost_calculated">
                  Costo Total Neto Almacene (CALCULADO)
                </FormLabel>
                <FormControl>
                  <Input
                  ...
                  <div className="overflow-y-auto">
                    <div className="flex space-x-4 py-2">
                      {importCost.import_costs_detail?.map((detail, index) => (
                        <div
                          key={index}
                          className="bg-white p-4 rounded-lg w-full border"
                        >
